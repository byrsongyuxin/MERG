    ...
    def __init__(self, net_params):
        ...
        for i in range(n_layers-1):
            if i in [0,8]:
                ...
                edge_lr = False
            layers_list.append(GatedGCNLayer(hidden_dim, hidden_dim, dropout,self.batch_norm, self.residual, edge_lr))
        layers_list.append(GatedGCNLayer(hidden_dim, hidden_dim, dropout, self.batch_norm, self.residual, edge_lr=False))
